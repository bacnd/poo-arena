...
const copyFonts = () => {
  return src('assets/fonts/**/*.{svg,eot,ttf,woff,woff2}')
...
const watchForChanges = () => {
  ...
  watch('assets/images/**/*.{png,jpg,jpeg,gif,svg}', series(cleanImages, copyImages));
  watch('assets/fonts/**/*.{svg,eot,ttf,woff,woff2}', series(cleanFonts, copyFonts));
}
